package com.yang.lutong.ui.dashboard;
...
import com.yang.lutong.R;
import com.yang.lutong.bean.BaseApp;
import com.yang.lutong.bean.DataBean;
import com.yang.lutong.bean.Event2;
import com.yang.greendao.greendaodemo.db.DataBeanDao;
...
public class RecAdapter extends RecyclerView.Adapter<RecAdapter.Vh> {
    ...
    public RecAdapter(List<DataBean> resultsBeans, Context con) {
